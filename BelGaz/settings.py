...
Django settings for BelGaz project.
...
SECRET_KEY = '_lz*bj1)+rw-gtf24qe3aca)r5dpobaf-1390m7zftuiaj+2t-'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': 'debug.log',  # при релизе сделать путь для хранения логов на сервере
        },
    },
    'loggers': {
        'django.request': {
